...
fn fs_main(in: VertexOutput) -> [[location(0)]] vec4<f32> {
    ...
    let specular_strength = pow(max(dot(tangent_normal, half_dir), 0.0), 1.0 + object_shininess.g * 32.0);
    let specular_color = object_shininess.r * specular_strength * light.color;
